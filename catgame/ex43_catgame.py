...
# cat omw to get a treat.
# has to pass scenes: sleepng owner, table blocking kitchen, hidden cupboard,
# the lid of the kitty snacks. Victory(eat snack, win), or no dinner(death)
